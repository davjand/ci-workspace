...
##git submodule add git@github.com:kanduvisla/author_roles.git public_html/extensions/author_roles --recursive
##git submodule add git@github.com:symphonycms/members.git public_html/extensions/members --recursive
##git submodule add git@github.com:scottkf/massuploadutility.git public_html/extensions/massuploadutility --recursive
##git submodule add git@github.com:lewiswharf/ab_split_test.git public_html/extensions/ab_split_test --recursive

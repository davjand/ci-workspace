...
curl -c curl_cookie.txt http://yourwebsite.com/symphony/login/TOKEN/
curl -b curl_cookie.txt http://yourwebsite.com/symphony/extension/database_migrations/?action=update
